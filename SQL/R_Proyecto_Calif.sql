...
FOREIGN KEY (Nomina) REFERENCES R_Profesor(Nomina) ON UPDATE CASCADE ON DELETE SET NULL) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=1;


JUEZZ:

CREATE TABLE IF NOT EXISTS `R_Juez` ( // NO USAR ESTE 
